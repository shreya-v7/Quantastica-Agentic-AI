...
export default function DashboardPage() {
  ...
  return (
    <div className="mx-auto max-w-7xl space-y-8">
      ...
      >
        <div>
          <p className="fi-eyebrow">Intelligence</p>
          <h1 className="fi-heading-xl mt-2">Overview</h1>
        ...
        {config.flags.ai && (
          <Link
            to="/chat"
            className="inline-flex items-center gap-2 self-start rounded-xl bg-primary px-4 py-2.5 text-sm font-semibold text-primary-foreground shadow-md shadow-primary/20 transition hover:opacity-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/40"
          >
